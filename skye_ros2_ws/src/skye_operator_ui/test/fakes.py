"""In-memory supervisor/bridge doubles shared by the unit tests.

Kept outside conftest.py so the suite also runs under --noconftest.
"""
...
def make_fake_stack():
    return FakeSupervisor(SessionLogic()), FakeBridge(), SnapshotBuilder()
