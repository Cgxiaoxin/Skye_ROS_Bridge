...
**日期：** 2026-08-21  
**状态：** P6.1–P6.3 已实现；**2026-09-10 Thor 真机冒烟通过**（dummy + `intervention_cmd`：`AUTONOMOUS`↔`HUMAN`）。bench：`skye_ros2_ws/scripts/verify_hitl_p61_interfaces.sh`；启停见 [`docs/Hint_启动使用说明.md`](../../Hint_启动使用说明.md)。实现计划见 [`docs/superpowers/plans/2026-08-21-hitl-dagger-control-arbiter.md`](../plans/2026-08-21-hitl-dagger-control-arbiter.md)
